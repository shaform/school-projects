...
namespace HOMEWORK
{
	...
	inline ptn get_ptn(void *addr)
	{
		return ((sz_t ) addr) - HEADER;
	}
	inline void* get_mem(ptn u)
	{
		return (void *) (u + HEADER);
	}
	inline sz_t &get_size(ptn ptr)
	{
		return *((sz_t *) ptr);
	}
	inline ptn &get_down(ptn ptr)
	{
		return ((header *) ptr)->down;
	}
	inline ptn &get_up(ptn ptr)
	{
		return ((header *) ptr)->up;
	}
	inline ptn &get_larger(ptn ptr)
	{
		return ((header *) ptr)->larger;
	}
	inline ptn &get_lesser(ptn ptr)
	{
		return ((header *) ptr)->lesser;
	}
	...
	inline ptn get_next(ptn u)
	{
		return u + DATA + get_size(u);
	}
	inline ptn get_prev(ptn u)
	{
	...
	inline bool is_top(ptn u)
	{
		return get_up(u) == root;
	}
	...
	inline void delete_f(ptn u)
	{
		get_down(u) = ACQUIRED;
	}
	inline bool is_free(ptn u)
	{
		return get_down(u) != ACQUIRED;
	}
	inline bool in_lst(ptn u)
	{
		return get_down(u) != NOTINLIST;
	}
